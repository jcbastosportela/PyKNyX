...
from pyknyx.core.dptXlator.dptXlatorDate import *
import unittest
...
class DPTDateTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.testTable = (
            (( 1,  1, 2000), 0x010100, b"\x01\x01\x00"),
            (( 1,  1, 2068), 0x010144, b"\x01\x01\x44"),
            (( 1,  1, 1969), 0x010145, b"\x01\x01\x45"),
            ((31, 12, 1999), 0x1f0c63, b"\x1f\x0c\x63"),
        )
