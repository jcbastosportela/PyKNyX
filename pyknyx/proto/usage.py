...
#from pyknyx import GroupAddressManager, Rule, RuleManager, Scheduler
#
#scheduler = Scheduler()
#
#
...
#from pyknyx.services import group, schedule, log, manager
#from pyknyx.elements import Rule
#
#
...
#from pyknyx.services import schedule, manager
#from pyknyx.elements import Rule
#
#
#class HeatingRules(Rule):
...
#from pyknyx.services import Trigger, Logger  #, Scheduler
#from pyknyx.managers import RulesManager, GroupAddressManager
#
##schedule = Scheduler()
#trigger = Trigger()
#logger = Logger()
...
#from pyknyx.api import Device, Stack, ETS
#
#stack = Stack()
#ets = ETS(stack)
#
