...
class T_GroupDataService(N_GroupDataListener):
    ...
    @type _ngds: L{N_GroupDataService<pyknyx.core.layer3.n_groupDataService>}

    @ivar _tgdl: transport group data listener
    @type _tgdl: L{T_GroupDataListener<pyknyx.core.layer4.t_groupDataListener>}
    """
    def __init__(self, ngds):
        """

        @param ngds: Network group data service object
        @type ngds: L{L_GroupDataService<pyknyx.core.layer3.n_groupDataService>}
    ...
    def setListener(self, tgdl):
        ...
        @type tgdl: L{T_GroupDataListener<pyknyx.core.layer4.t_groupDataListener>}
        """
        self._tgdl = tgdl
